...
make port-forward                     # Prometheus :9090, Alertmanager :9093, Loki API :3100, Grafana :3000 (can be toggled off with GRAFANA=0 during make cluster or make observability)
